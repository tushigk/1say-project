                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className={`flex items-center gap-1.5 text-xs truncate ${chat.unread ? 'text-zinc-200 font-bold' : 'text-zinc-500'}`}>
                                        {chat.unread && <span className="w-2 h-2 shrink-0 rounded-full bg-red-500 shadow-[0_0_8px_rgba(239,68,68,0.8)]" />}
                                        <span className="truncate">{chat.lastMessage?.body || 'Зурвас алга...'}</span>
                                    </p>
                                </div>
                                {chat.unread && (
