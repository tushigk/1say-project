...
export default function LoginPage() {
    ...
    return (
        <div className="relative min-h-screen overflow-hidden bg-[#07070a] text-white">
            ...
            <div className="absolute top-20 left-10 h-40 w-40 rounded-full bg-red-500/10 blur-3xl" />
            <div className="absolute bottom-20 right-10 h-56 w-56 rounded-full bg-white/5 blur-3xl" />
            <div className="absolute top-1/3 right-1/4 h-28 w-28 rounded-full bg-red-400/10 blur-2xl" />
                    ...
                    <div className="relative overflow-hidden rounded-[2.5rem] border border-white/10 bg-white/[0.06] p-8 shadow-[0_30px_80px_rgba(0,0,0,0.55)] backdrop-blur-2xl sm:p-10 md:p-12">
                        ...
                        <div className="mb-8 flex flex-col items-center text-center">
                            ...
                            <motion.p
                                ...
                                className="mt-2 max-w-sm text-sm leading-relaxed text-zinc-400"
                            >
